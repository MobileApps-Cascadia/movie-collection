...
public class SampleData {
    ...
    public static List<MovieEntity> getMovies (){
        ...
        moviesList.add(new MovieEntity(455,"My Neighbor Totoro", "Misyazaki, Hiayao", "1988", 86) );
        moviesList.add(new MovieEntity(345,"Spirited Away", "Misyazaki, Hiayao", "2001", 125) );
